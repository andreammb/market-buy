      ...
      {isOpen ? (
        <form action={formAction}>
          <div className="pb-8">
            ...
            <SubmitButton className="mt-6" data-testid="submit-address-button">Continue con la entrega</SubmitButton>
              ...
              <div className="flex items-start gap-x-8">
                <div className="flex items-start gap-x-1 w-full">
                  ...
                  <div className="flex flex-col w-1/3" data-testid="billing-address-summary">
                    ...
                    {sameAsSBilling ? (
                      <Text className="txt-medium text-ui-fg-subtle">
                        Las direcciones de facturacion y entrega son la misma.
                      </Text>
                    ) : (
                      <>
                        <Text className="txt-medium text-ui-fg-subtle">
